...
1. 파일에서 **botAadApp/create** 작업을 사용하는 단계를 찾아 다음으로 바꿉니다.
...
1. 파일에서 **botFramework/create** 작업을 사용하는 단계를 제거합니다.
1. 변경 내용을 저장합니다.
...
:::image type="content" source="../media/18-select-dev-tunnel.png" alt-text="Visual Studio의 확장된 개발 터널 메뉴 스크린샷" lightbox="../media/18-select-dev-tunnel.png":::

Visual Studio에서 다음을 테스트합니다.

1. 도구 모음에서 **Microsoft Teams(브라우저) 버튼 옆에 있는 드롭다운을 선택**하여 디버그 프로필 메뉴를 확장합니다.
...
:::image type="content" source="../media/app/color-local.png" alt-text="로컬 개발에 사용되는 색 아이콘입니다." lightbox="../media/app/color-local.png":::

:::image type="content" source="../media/app/color-dev.png" alt-text="원격 개발에 사용되는 색 아이콘입니다." lightbox="../media/app/color-dev.png":::
...
1. 파일에서 **아이콘**, **이름 및 **설명** 개체를 다음으로 업데이트합니다.
...
:::image type="content" source="../media/19-prepare-teams-app-dependencies.png" alt-text="Visual Studio의 확장된 Teams 도구 키트 메뉴 스크린샷" lightbox="../media/19-prepare-teams-app-dependencies.png":::
...
1. **프로비전** 대화 상자에서 Azure에 리소스를 배포하는 데 사용할 계정을 선택하고 다음 값을 지정합니다.
    ...
    1. **리소스 그룹**: 새로 만들기...를 선택하여 대화 상자를 열고 **rg-msgext-product-support-local을 입력한 후 **확인**을 선택합니다.
